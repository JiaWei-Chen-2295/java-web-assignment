...
<body>
    ...
    <div class="container">
        ...
        <div class="image-section">
            ...
            <jsp:include page="dynamic-image.jsp" />
            <p style="color: #666; margin-top: 15px; font-style: italic;">
                The image tag is generated by a separately executed JSP (runtime include).
            </p>
        </div>

        <jsp:include page="server-time.jsp" />
...
&lt;%-- Dynamic include for fragment (request time) --%&gt;
<span class="highlight">&lt;jsp:include page="dynamic-image.jsp" /&gt;</span>

&lt;%-- Dynamic include for server time (request time) --%&gt;
<span class="highlight">&lt;jsp:include page="server-time.jsp" /&gt;</span>
        </div>
