...
<head>
    <meta charset="UTF-8">
    <title>登录 - Server-Relative路径</title>
    <style>
        ...
        .path-type { text-align: center; color: #FF9800; font-size: 12px; margin-bottom: 20px; }
        .form-group { margin-bottom: 20px; }
        label { display: block; margin-bottom: 5px; color: #555; }
        input[type="text"], input[type="password"] { width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; box-sizing: border-box; }
        button { width: 100%; padding: 12px; background-color: #FF9800; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 16px; }
...
<body>
    <div class="login-form">
        <h2>用户登录</h2>
        <div class="path-type">方式3: Server-Relative路径</div>
        ...
        <div class="code">action="/ch05/login"</div>
    </div>
</body>
</html>
